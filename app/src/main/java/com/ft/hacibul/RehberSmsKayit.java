...
public class RehberSmsKayit extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.rehber_sms_kayit);
        ...
        kayitOl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(getApplicationContext(),"Boş alan bırakılamaz. Lütfen tüm alanları doldurunuz.",Toast.LENGTH_LONG);
                }

                else {
                    veritabanınaKayıtEt();
                    Intent intent = new Intent(RehberSmsKayit.this, MainActivity.class);
    ...
    public void veritabanınaKayıtEt()
    {
        ...
        mReference.child("rehberler").child(userId)
                .setValue(mData)
                .addOnCompleteListener(RehberSmsKayit.this, new OnCompleteListener<Void>() {
                    @Override
                    public void onComplete(@NonNull Task<Void> task) {
                        if(task.isSuccessful())
                        {
                            Toast.makeText(RehberSmsKayit.this,"Kayıt İşlemi Başarılı",Toast.LENGTH_SHORT).show();
                        }
                        else
                        {
                            Toast.makeText(RehberSmsKayit.this,"Kayıt İşlemi Başarısız",Toast.LENGTH_SHORT).show();
